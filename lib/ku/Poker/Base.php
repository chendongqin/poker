...
class Base
{
    ...
    protected $_pokers = [
        ['id'=>1,'value' => 14, 'desc' => '黑桃A', 'type' => 1, 'photo' => ''],
        ...
        ['id'=>14,'value' => 14, 'desc' => '红心A', 'type' => 2, 'photo' => ''],
        ...
        ['id'=>27,'value' => 14, 'desc' => '梅花A', 'type' => 3, 'photo' => ''],
        ...
        ['id'=>40,'value' => 14, 'desc' => '方块A', 'type' => 4, 'photo' => ''],
    ...
    public function __construct($roomId,$joinKing = false)
    {
        ...
        if($joinKing ){
            ...
            array_push($pokers,['id'=>53,'value' => 15, 'desc' => '小王', 'type' => 5, 'photo' => '']);
            array_push($pokers,['id'=>54,'value' => 16, 'desc' => '大王', 'type' => 5, 'photo' => '']);
